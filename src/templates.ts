export type TemplateType = "webpart" | "library" | "extension" | "adaptive-card-extension";

export const VARIANT_CHOICES: Record<TemplateType, { title: string; value: string }[]> = {
    webpart: [
...
export function variantLabel(extType?: string) {
    switch (extType) {
